...
<head>
    ...
    <title> Become a Volunteer- Peka Peduli Sulawesi</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header__inner">
                    <h2 class="wow fadeInDown" data-wow-duration="1500ms">Become a Volunteer</h2>
        ...
        <!--Start Become Volunteer Page-->
        <section class="become-volunteer-page">
            <div class="container">
                <div class="row">
                    <!--Start Become Volunteer Page Content-->
                    <div class="col-xl-6">
                        <div class="become-volunteer-page__content">
                            <div class="become-volunteer-page__content-text1">
                                <h2>Let’s join our community <br>
                                    to become a volunteer</h2>
                                <div class="img-box">
                                    <img src="assets/images/resources/become-volunteer-page-img1.jpg" alt="">
                                </div>
                            </div>

                            <div class="become-volunteer-page__content-text2">
                                <h2>Volunteer Requirements</h2>
                                <p>Discover the inspiring stories of individuals and communities transformed by our
                                    programs. Our success stories highlight the real-life impact</p>
                                <div class="become-volunteer-page__content-text2-quote">
                                    <p>Helped fund 589,537 Projects in 24 Countries,Benefiting over
                                        45k+ Million people.</p>
                                </div>
                                <ul class="become-volunteer-page__content-text2-list">
                                    <li>
                                        <p>All the generators on the Internet tend to repeat predefined</p>
                                    </li>
                                    <li>
                                        <p>Embarrassing generators on the Internet tend </p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <!--End Become Volunteer Page Content-->

                    <!--Start Become Volunteer Page Form-->
                    <div class="col-xl-6">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="comment-form__btn-box">
                                            <button type="submit" class="thm-btn comment-form__btn">
                                                Send Request <span class="icon-diagonal-arrow1"></span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!--End Become Volunteer Page Form-->
                </div>
            </div>
        </section>
        <!--End Become Volunteer Page-->
