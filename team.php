...
<head>
    ...
    <title> Volunteers- Peka Peduli Sulawesi</title>
    <!-- favicons Icons -->
        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header__inner">
                    <h2 class="wow fadeInDown" data-wow-duration="1500ms">Volunteers</h2>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="team-one__single">
                            <div class="team-one__single-img">
                                ...
                                <div class="team-one__single-content">
                                    <div class="text-box">
                                        <h2><a href="team-details.php">Jenny Wilson</a></h2>
                                        <p>Volunteer</p>
                                    </div>
                                </div>
                                <div class="team-two__social">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInDown" data-wow-delay=".3s">
                        <div class="team-one__single">
                            <div class="team-one__single-img">
                                ...
                                <div class="team-one__single-content">
                                    <div class="text-box">
                                        <h2><a href="team-details.php">Robert Fox</a></h2>
                                        <p>Volunteer</p>
                                    </div>
                                </div>
                                <div class="team-two__social">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="team-one__single">
                            <div class="team-one__single-img">
                                ...
                                <div class="team-one__single-content">
                                    <div class="text-box">
                                        <h2><a href="team-details.php">Ralph Edwards</a></h2>
                                        <p>Volunteer</p>
                                    </div>
                                </div>
                                <div class="team-two__social">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInDown" data-wow-delay=".3s">
                        <div class="team-one__single">
                            <div class="team-one__single-img">
                                ...
                                <div class="team-one__single-content">
                                    <div class="text-box">
                                        <h2><a href="team-details.php">Kristin Watson</a></h2>
                                        <p>Volunteer</p>
                                    </div>
                                </div>
                                <div class="team-two__social">
