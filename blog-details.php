...
<head>
    ...
    <title> Blog Details- Peka Peduli Sulawesi</title>
    <!-- favicons Icons -->
                        ...
                        <div class="blog-details__content">
                            <div class="blog-one__single">
                                ...
                                <div class="blog-one__single-content">
                                    ...
                                    <h2>How Clean Water Changed a Village in Kenya</h2>
                                    <p>Explore the variety of volunteer opportunities available. From event planning and
                                        fundraising to field administrative support, there are many ways to lend your
                                        talents. Find the perfect fit for your skills and interests. Volunteers are the
                                        heart of our organization. Join our team to make a hands-on difference in your
                                        community. Whether you have a few hours or a few days, your time and skills </p>
                                </div>
                            </div>

                            <div class="blog-details__content-text1">
                                <div class="blog-details__content-text1-icon">
                                    <span class="icon-double-quotes2"></span>
                                </div>
                                <div class="blog-details__content-text1-inner">
                                    <p>Specialized cleaning to remove construction dust, debris, and residues left after
                                        <br>
                                        renovation or remodeling projects.</p>
                                </div>
                                <div class="blog-details__content-text1-btn">
                                    <a href="#">Annette Black</a>
                                </div>
                            </div>

                            <div class="blog-details__content-text2">
                                <p class="text1">They bring enthusiasm, skills, and time, which are crucial for driving
                                    the mission forward. Volunteers help in various capacities, from organizing events
                                    to directly assistin those in need, making them indispensable part of the charity
                                    ecosystem. Activities may include tutoring, mentoring,</p>
                                <div class="blog-details__content-text2-img">
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-6">
                                            <div class="blog-details__content-text2-img-single">
                                ...
                                <p class="text2">Explore the variety of volunteer opportunities available. From event
                                    planning and fundraising to field administrative support, there are many ways to
                                    lend your talents. Find the perfect fit for your skills and interests. Volunteers
                                    are the heart of our organization. Join our team to make a hands-on difference</p>
                            </div>
                        ...
                        <div class="sidebar">
                            ...
                            <div class="sidebar__single sidebar__categories">
                                ...
                                <ul class="sidebar__categories-list">
                                    <li><a class="active" href="#">Donations <span class="icon-right-arrow"></span></a>
                                    </li>
                                    <li><a href="#">Educations <span class="icon-right-arrow"></span></a></li>
                                    <li><a href="#">Fundraising <span class="icon-right-arrow"></span></a></li>
                                    <li><a href="#">Foods <span class="icon-right-arrow"></span></a>
                                    </li>
                                    <li><a href="#">Medical Help <span class="icon-right-arrow"></span></a></li>
                                    <li><a href="#">Water Support <span class="icon-right-arrow"></span></a></li>
                                </ul>
                            </div>
                            <!--End Sidebar Single-->
