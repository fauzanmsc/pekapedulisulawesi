...
<head>
    ...
    <title> Donations- Peka Peduli Sulawesi</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header__inner">
                    <h2 class="wow fadeInDown" data-wow-duration="1500ms">Donations</h2>
        ...
        <!--Start Cause One-->
        <section class="cause-one cause-one--cause">
            <div class="container">
                        ...
                        <div class="cause-one__single">
                            <div class="cause-one__single-inner">
                                ...
                                <div class="cause-one__single-content">
                                    ...
                                    <h2><a href="donation-details.php">Helping the Homeless During <br> Hopeless</a>
                                    </h2>
                                    <div class="btn-box">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="cause-one__single">
                            <div class="cause-one__single-inner">
                                ...
                                <div class="cause-one__single-img">
                                    <img src="assets/images/resources/cause-v1-img4.jpg" alt="">
                                </div>
                                <div class="cause-one__single-content">
                                    <div class="cause-one__rised-and-progress">
                                        <div class="title-box">
                                    ...
                                    <h2><a href="donation-details.php">Assisting the Homeless in <br> Times of
                                            Hopelessness</a></h2>
                                    <div class="btn-box">
                                        <a href="donation-details.php" class="thm-btn">Kirim Donasi <span
                                                class="icon-diagonal-arrow1"></span></a>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="cause-one__single">
                            <div class="cause-one__single-inner">
                                ...
                                <div class="cause-one__single-img">
                                    <img src="assets/images/resources/cause-v1-img5.jpg" alt="">
                                </div>
                                <div class="cause-one__single-content">
                                    <div class="cause-one__rised-and-progress">
                                        <div class="title-box">
                                    ...
                                    <h2><a href="donation-details.php">Aiding the Homeless When <br> Things Seem
                                            Hopeless</a></h2>
                                    <div class="btn-box">
                                        <a href="donation-details.php" class="thm-btn">Kirim Donasi <span
                                                class="icon-diagonal-arrow1"></span></a>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="cause-one__single">
                            <div class="cause-one__single-inner">
                                ...
                                <div class="cause-one__single-img">
                                    <img src="assets/images/resources/cause-v1-img6.jpg" alt="">
                                </div>
                                <div class="cause-one__single-content">
                                    <div class="cause-one__rised-and-progress">
                                        <div class="title-box">
                                    ...
                                    <h2><a href="donation-details.php">While Hopeless, Assisting the <br> Homeless
                                        </a></h2>
                                    <div class="btn-box">
                                        <a href="donation-details.php" class="thm-btn">Kirim Donasi <span
                                                class="icon-diagonal-arrow1"></span></a>
