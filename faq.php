...
<head>
    ...
    <title> Faq- Peka Peduli Sulawesi</title>
    <!-- favicons Icons -->
                    ...
                    <div class="col-xl-6">
                        <div class="faq-page__content">
                            <div class="sec-title sec-title-animation animation-style2">
                                ...
                                <h2 class="sec-title__title title-animation">Key Questions Answered <br> About Our
                                    Charity <br> Initiatives
                                </h2>
                            </div>

                            <div class="faq-page__content__text">
                                <p>Partner with us to make a greater impact. Our corporate sponsorship program offers
                                    businesses the opportunity to support our mission while gaining visibility and
                                    fulfilling corporate social responsibility goals.</p>
                            </div>
                            <div class="faq-page__content__text2">
                                <div class="faq-page__content__text2-top">
                                    <div class="icon-box">
                                        <div class="inner">
                                ...
                                <div class="faq-page__content__text2-btn">
                                    <a href="contact.php" class="thm-btn">Contact Us <span
                        ...
                        <div class="faq-page-faq">
                            <div class="faq-one__content-faq">
                                <div class="accrodion-grp faq-one-accrodion" data-grp-name="faq-one-accrodion-1">
                                    ...
                                    <div class="accrodion">
                                        <div class="accrodion-title">
                                            <h4>How do I know the impact of my donation?</h4>
                                        </div>
                                    ...
                                    <div class="accrodion">
                                        <div class="accrodion-title">
                                            <h4>Can I choose where my donation goes?</h4>
                                        </div>
